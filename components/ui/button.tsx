...
export function Button({
  ...
  return (
    <a
      href={href}
      className={`inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-semibold transition-colors duration-200 ${sizing} ${variants[variant]} ${className}`}
    >
      {children}
    </a>
  );
